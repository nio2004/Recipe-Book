      ...
      <div class="w-fit min-w-[400px] bg-white/70 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 class="text-xl text-black font-semibold leading-tight tracking-tight  md:text-2xl">
                  <span className='text-darkred'>Log in</span> to your account
              </h1>
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <button type="submit" className="w-full hover:text-black bg-primary-600 bg-darkred text-white text-md focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Log in</button>
