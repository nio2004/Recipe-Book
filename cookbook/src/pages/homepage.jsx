...
const Homepage = () => {
  return (
    <div className='h-[90vh] bg-transparent'>
        ...
        <div className='bg-darkred rounded-xl relative left-10 top-1/3 mt-10 w-fit p-1 px-4 text-white' role='button'><Link to='/signup'>SignUp</Link></div>                                               
        <div className='text-md  relative top-1/3 left-10 mt-5' role='button'>Do You Have Account? <span className='text-darkred'><Link to='/login'>Log In</Link></span></div>
    </div>
  )
}
